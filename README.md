# <center> Architecture to IaC code</center> 
...
## Architecture to IaC code using Anthropic Claude 3 model family's vision capabilities on Amazon Bedrock
...
## Architecture to IaC using Amazon Bedrock Agents and Knowledge Bases
